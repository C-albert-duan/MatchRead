...
| #   | Check          | How                                       |
| --- | -------------- | ----------------------------------------- |
| D.1 | Tournament map | Provider id ↔ MatchRead tournament row; **`tour` stored on row** (ATP + WTA) |
...
| D.5 | Dual-tour week | `probe:rapidapi calendar` → Montreal ATP `21346` + Toronto WTA `16739` |
